...
const placeholder = {
  fullName: "Danyal Asif",
  jobTitle: "Frontend Developer",
  profileInput: "Hi, I like Stuff",
  skills: [{ id: 1, name: "React", desc: "I love React" }],
};

const Preview = () => {
  const [value] = useEditorData();
  console.log({ value });
  const tempVal = value.fullName ? value : placeholder;
  return (
      ...
      <div className="my-4 p-2 bg-slate-100 rounded border">
        ...
        <div className="flex flex-row">
          {tempVal.skills.map((skill) => {
            return (
              <div key={skill.id} className="border rounded p-1 m-2 first:ml-0 w-1/3 bg-blue-100">
